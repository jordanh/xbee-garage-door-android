...
public class DiaChannelDataFullList {
    private static final long serialVersionUID = 7526472295622776105L;
    ...
    private ArrayList<DiaChannelDataFull> list;

    public ArrayList<DiaChannelDataFull> getList() {
        if (this.list == null)
            this.list = new ArrayList<DiaChannelDataFull>(0);
