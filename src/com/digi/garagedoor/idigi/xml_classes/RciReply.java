...
@Root(name = "rci_reply", strict = false)
public class RciReply {
    ...
    private ArrayList<DoCommand> list;

    public ArrayList<DoCommand> getList() {
        if (this.list == null)
            this.list = new ArrayList<DoCommand>(0);
